...
- Üç HTML girişli çok sayfalı yapıyı koruyun: `/`, `/projects/`, `/contact/`. Kullanıcının isteğiyle Hakkımda sayfası ve anasayfa özeti kaldırıldı. Sayfa yolları `src/data/pages.ts` içindedir. Yayında tüm adresleri anasayfaya yönlendiren SPA rewrite kullanmayın.
- Kullanıcının seçtiği #000d15, #05172f, #2d3c4c, #2f2f2b ve #525453 zemin paletini; kırık beyaz metinleri, şampanya vurguları, geniş boşlukları ve ölçülü tipografiyi koruyun. Gerçek görsel yokken tipografik proje kapakları kullanın.
