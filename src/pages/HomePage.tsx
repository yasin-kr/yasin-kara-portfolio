...
export function HomePage() {
  ...
  return (
    <>
      ...
      <section
        id="featured-work"
        className="home-work page-width section"
      ...
      >
        <div className="section-heading">
          ...
          <a href={pagePaths.projects} className="text-link">
        ...
        <div className="project-previews">
          {projects.map((project) => (
            <article className="project-preview" key={project.id}>
              ...
              <p className="eyebrow preview-role" dir={textDirection}>
                {project.role}
              </p>
              <p className="preview-summary" dir={textDirection}>
                {project.summary}
              </p>
            </article>
          ))}
      ...
      >
        <div className="page-width home-about-layout">
          <div>
            <p className="eyebrow section-index" dir={textDirection}>
              {t.ui.aboutIndex}
            </p>
          ...
          <div className="home-about-copy">
            ...
            <div className="home-about-links">
              <a href={pagePaths.about} className="text-link">
